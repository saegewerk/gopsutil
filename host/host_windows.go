...
import (
	...
	"github.com/saegewerk/gopsutil/process"
...
func HostIDWithContext(ctx context.Context) (string, error) {
	// there has been reports of issues on 32bit using golang.org/x/sys/windows/registry, see https://github.com/saegewerk/gopsutil/pull/312#issuecomment-277422612
